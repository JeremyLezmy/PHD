\message{ !name(02_ztf.tex)}\documentclass[../main/main.tex]{subfiles}
\begin{document}

\message{ !name(02_ztf.tex) !offset(-3) }
...
ce flux d'alertes utilise des technologies dont le code source est public développées
...
10 est public: Toutes les observations MSIP de Mars 2018 au 5 Novembre
...
magnitude de ZTF permettant d'établir une courbe de lumière exploitable.
...
ans et demi d'observations (Mars 2018-Novembre 2020), ZTF a déjà répertorié plus de $3000$ SNIa.

\section{Supernovae Ia, ZTF et Cosmologie}\label{sec:sniaztfcosmo}
...
\message{ !name(02_ztf.tex) !offset(-331) }
