...
\begin{equation*} 
  S_{pADU}(\lambda,t,z) = \frac{S(\lambda,t,z)}{\mathcal{C}_{atm}(\lambda,t,z)}=S^{\star}(\lambda,t)\times\mathcal{C}_{inst}(\lambda,t)\times\left(1-\mathcal{E}_{tell}(\lambda,t,z)\right)
\end{equation*}
...
ajustées en minimisant la quantité ~$(S_{pADU}/S_{ref}) - \mathcal{C}_{inst}(1-
...
\begin{figure}[ht]
  ...
  ratio $\frac{S_{pADU}}{S_{ref}}$, est en bleu.}
