...
\subsection{\'Echantillonage des spectres dans l'espace SEDm}
% \label{ssec:xxx}
...
étendues de $3700$\AA\ à $9300$\AA\, soit un échantillonnage spectrale
d'environ $25.57$\AA.

Comme nous l'illustrons dans la Figure~\ref{fig:cigalesampling},
l'échantillonnage spectral des SED de sortie de \cigale est inférieur à
$5$\AA, mais n'est pas uniforme.

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.99\textwidth]{../figures/05_sedfit/cigalesampling.pdf}
  \caption[\'Echantillonage spectral d'une SED obtenue avec
  \cigale]{\'Echantillonage spectral d'une SED obtenue avec \cigale. À
    gauche la SED entre $3000$ et $10000$\AA, et à droite l'histogramme
    de la taille d'échantillonage de cette SED.}}
  \label{fig:cigalesampling}
\end{figure}
