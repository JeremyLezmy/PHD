...
\begin{comment}
En posant la distance comobile $R(t)$ entre deux objets à l'instant $t$, et
leur distance actuelle $R_{0}$ à l'instant $t_{0}$, nous avons par
définition du facteur d'échelle que:
\begin{align*}
  R(t)&=a(t)\frac{R_{0}}{a_{0}}\\
  \dot{R}(t)&=\dot{a}(t)\frac{R_{0}}{a_{0}} \Leftrightarrow \dot{R}(t)=\frac{\dot{a}(t)}{a(t)}R(t)
\end{align*}
\end{comment}
