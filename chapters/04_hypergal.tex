...
l'instrument et de prendre en compte les conditions
...
des informations photométriques de la galaxie encore exempt de la supernova.
...
La cible choisie est ZTF18accrorf, dont le cube extrait à partir d'une
...
\begin{figure}[ht]
  ...
  \caption[Cube 3D SEDm de ZTF18accrorf]{Cube 3D d'une observation de
    ...
    assez aisément distinguable de sa galaxie hôte, avec une séparation
...
\begin{figure}[ht]
  ...
  \caption[Extraction de ZTF18accrorf avec \pysedm]{Extraction de
    ZTF18accrorf avec \pysedm. Sur la \textit{gauche} est représentée une image 2D
  ...
  spaxels sélectionnés pour l'extraction automatique. \textit{En haut à
    droite} est représentée la modélisation d'une méta-tranche et le
...
montrerons quelques cas d'extraction extrême où la supernova est quasiment
